...
A1: We filtered out the genetic tags of chloroplasts and mitochondria out of our phyloseq object. This leaves us with sub_ps, a dataframe which only contains information related to bacterial OTUs within our data.
...
A2: Sequencing depth is the sum of the amount of reads ran through your system to a certain point. So if your depth is say 50,000 then you have dug 50,000 samples into your pile of unprocessed data out of X many.
...
A3: I don't really think so since the difference between the two variables with one being subsampled is relatively minute in my opinion (especially if a 2:1 before/after ratio was considered a small impact and this is pretty much an 8:6 ratio).
...
A4: The datasets used to make the two graphs were our initial filtered table and then the subsampled table. From the look of it, we'll be using subsetted data as the relationships are more characterized.
...
A5: In both locations the control start out more similar to each other but over the course of the experiment the the control and Leachate treatments separate and become more similar to other identical treatments. Curiously the Ash Leachate in San Diego was noticably dissimilar compared to the closer Santa Barbara, but San Diego also had a more similar day 0 diversity accross treatments.
...
A6: Within both test groups the overall alpha diversity decreased over the test period, though eveness did not significantly decrease.The control group was already more diverse than the Leachate group going into the experiment but wasn't different in terms of overall diversity. By the end of the experiment the treatments were significantly different in both alpha diversity as well as overall diversity (i.e. factoring in eveness).
...
A7: Main "winners" in Leachate versus the control treatment were Alteromonadales,Oceanospirales, and Campylobacterales, who all saw a noticable increase in relative abundance vs their populations in the control treatment. Some taxa decreases in relative abundance in the Leachate treatment, like Cellvibrionales and SAR11.
